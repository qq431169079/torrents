...
import (
	...
	"github.com/videofree/torrents/api"
	"github.com/videofree/torrents/lockfile"
...
func main() {
	...
	for _, line := range strings.Split(TorrentsLogo, "\n") {
		log.Debug(line)
	}
	...
	xbmc.Notify("Torrents", "LOCALIZE[30208]", config.AddonIcon())
