...
PROJECT = quasarhq
NAME = quasar
GO_PKG = github.com/videofree/torrents
GO = go
GIT = git
DOCKER = docker
...
LIBTORRENT_GO = github.com/videofree/libtorrent-go
...
binaries:
	...
	git clone --depth=1 https://github.com/videofree/torrents-binaries binaries
